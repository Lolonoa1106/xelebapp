...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6237],
  {
    12829: (t, e, r) => {
      ...
      var S = Object.defineProperty,
        ...
        C = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        _ = (t, e) => {
          for (var r in e || (e = {})) N.call(e, r) && C(t, r, e[r]);
          if (I) for (var r of I(e)) B.call(e, r) && C(t, r, e[r]);
          return t;
        };
      let O = {
      ...
      function P() {
        return !R() && !!(0, a.getNavigator)() && !!(0, a.getDocument)();
      }
      function U() {
        return k() ? O.reactNative : R() ? O.node : P() ? O.browser : O.unknown;
      }
      function T() {
        var t;
        try {
      ...
      function D() {
        return (
          (0, l.g)() || { name: "", description: "", url: "", icons: [""] }
        );
      }
      function F({
        protocol: t,
      ...
      async function Z({ id: t, topic: e, wcDeepLink: i }) {
        try {
          if (!i) return;
      ...
      async function $(t, e) {
        try {
          return (
            (await t.getItem(e)) || (P() ? localStorage.getItem(e) : void 0)
          );
        } catch (t) {
          console.error(t);
        }
      ...
      !(function (t) {
        !(function () {
          ...
          for (
            ...
            for (var I = x[S], N = I.bits, B = 0; B < N.length; ++B) {
              var C = I.name + "_" + N[B];
              if (
                (E.push(C),
      ...
      let ti = !1,
        tn = !1,
        to = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        tf = to.default,
        ts = null,
        tu = (function () {
          try {
      ...
      class ta {
        ...
        _log(t, e) {
          ...
          null == to[r] &&
            ...
            tf > to[r] || console.log.apply(console, e);
        }
        debug(...t) {
          this._log(ta.levels.DEBUG, t);
        }
        info(...t) {
          this._log(ta.levels.INFO, t);
        }
        warn(...t) {
          this._log(ta.levels.WARNING, t);
        }
        makeError(t, e, r) {
          if (tn) return this.makeError("censored error", e, {});
          e || (e = ta.errors.UNKNOWN_ERROR), r || (r = {});
          let i = [];
        ...
        throwArgumentError(t, e, r) {
          return this.throwError(t, ta.errors.INVALID_ARGUMENT, {
            argument: e,
            value: r,
          });
        }
        ...
        checkNormalize(t) {
          tu &&
            this.throwError(
              ...
              { operation: "String.prototype.normalize", form: tu }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
            ...
            (t < 0 || t >= 0x1fffffffffffff) &&
              this.throwError(e, ta.errors.NUMERIC_FAULT, {
        ...
        checkArgumentCount(t, e, r) {
          (r = r ? ": " + r : ""),
            t < e &&
              this.throwError(
                "missing argument" + r,
                ta.errors.MISSING_ARGUMENT,
                { count: t, expectedCount: e }
              ),
            t > e &&
              this.throwError(
                "too many arguments" + r,
                ta.errors.UNEXPECTED_ARGUMENT,
                { count: t, expectedCount: e }
              );
        }
        checkNew(t, e) {
          (t === Object || null == t) &&
            this.throwError("missing new", ta.errors.MISSING_NEW, {
              name: e.name,
            });
        }
        checkAbstract(t, e) {
        ...
        static globalLogger() {
          return ts || (ts = new ta("logger/5.7.0")), ts;
        }
        ...
        static setLogLevel(t) {
          let e = to[t.toLowerCase()];
          if (null == e) {
            ta.globalLogger().warn("invalid log level - " + t);
            return;
          }
          tf = e;
        }
      ...
      (ta.errors = n), (ta.levels = i);
      let tl = new ta("bytes/5.7.0");
      function td(t) {
        ...
        return (
          t.slice ||
            (t.slice = function () {
              ...
              return tc(new Uint8Array(Array.prototype.slice.apply(t, e)));
            }),
          t
        );
      }
      ...
      function tm(t) {
        ...
        if ("string" == typeof t || !tp(t.length) || t.length < 0) return !1;
        for (let e = 0; e < t.length; e++) {
          let r = t[e];
          if (!tp(r) || r < 0 || r >= 256) return !1;
        }
        return !0;
      }
      function tg(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          ...
          return 0 === e.length && e.push(0), tc(new Uint8Array(e));
        }
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tl.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
          for (let t = 0; t < r.length; t += 2)
            i.push(parseInt(r.substring(t, t + 2), 16));
          return tc(new Uint8Array(i));
        }
        return tm(t)
          ? tc(new Uint8Array(t))
          : tl.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tv(t, e) {
        return !(
          "string" != typeof t ||
      ...
      function ty(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tb(t))
            : (!tv(t) || t.length % 2) &&
              tl.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tw(t, e) {
        for (
          "string" != typeof t
            ? (t = tb(t))
            : tv(t) || tl.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
              tl.throwArgumentError(
                "value out of range",
                "value",
                arguments[1]
              );
      ...
      function tx(t) {
        ...
        if ((tv(t) && !(t.length % 2)) || tm(t)) {
          let r = tg(t);
          64 === r.length
            ? ((e.v = 27 + (r[32] >> 7)),
              (r[32] &= 127),
              (e.r = tb(r.slice(0, 32))),
              (e.s = tb(r.slice(32, 64))))
            : 65 === r.length
            ? ((e.r = tb(r.slice(0, 32))),
              (e.s = tb(r.slice(32, 64))),
              (e.v = r[64]))
            : tl.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tl.throwArgumentError(
          ...
          if (
            ...
            let r = (function (t, e) {
              ...
              return r.set(t, e - t.length), tc(r);
            })(tg(e._vs), 32);
            e._vs = tb(r);
            let i = r[0] >= 128 ? 1 : 0;
          ...
          let r = tg(e.s);
          r[0] >= 128 &&
            tl.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tb(r);
          e._vs &&
            (tv(e._vs) ||
              tl.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tw(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      !(function (t, e) {
          ...
          for (var h = 1; h < i; h++) {
            for (
              var a = u >>> 26,
                ...
                c = Math.max(0, h - t.length + 1);
              c <= d;
              c++
            ) {
              var p = (h - c) | 0;
              (a +=
                ((f = (n = 0 | t.words[p]) * (o = 0 | e.words[c]) + l) /
                  0x4000000) |
                0),
                (l = 0x3ffffff & f);
            }
        ...
        var m = function (t, e, r) {
          ...
          (r.negative = t.negative ^ e.negative),
            (r.length = 19),
            (i = Math.imul(l, z)),
            (n = ((n = Math.imul(l, j)) + Math.imul(d, z)) | 0),
            (o = Math.imul(d, j));
          ...
          (h = (((o + (n >>> 13)) | 0) + (tg >>> 26)) | 0),
            ...
            (o = Math.imul(m, j)),
            (i = (i + Math.imul(l, K)) | 0),
            (n = ((n = (n + Math.imul(l, Q)) | 0) + Math.imul(d, K)) | 0),
            (o = (o + Math.imul(d, Q)) | 0);
          ...
          (h = (((o + (n >>> 13)) | 0) + (tA >>> 26)) | 0),
            ...
            (o = (o + Math.imul(m, J)) | 0),
            (i = (i + Math.imul(l, W)) | 0),
            (n = ((n = (n + Math.imul(l, X)) | 0) + Math.imul(d, W)) | 0),
            (o = (o + Math.imul(d, X)) | 0);
          ...
          (h = (((o + (n >>> 13)) | 0) + (tb >>> 26)) | 0),
            ...
            (o = (o + Math.imul(w, Q)) | 0),
            (i = (i + Math.imul(v, Y)) | 0),
            (n = ((n = (n + Math.imul(v, J)) | 0) + Math.imul(A, Y)) | 0),
            (o = (o + Math.imul(A, J)) | 0),
            (i = (i + Math.imul(p, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tw >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(l, tf)) | 0) + Math.imul(d, to)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tx >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(l, th)) | 0) + Math.imul(d, tu)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tM >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(v, tf)) | 0) + Math.imul(A, to)) | 0),
            (o = (o + Math.imul(A, tf)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tE >>> 26)) | 0),
            (tE &= 0x3ffffff),
            (i = Math.imul(F, z)),
            (n = ((n = Math.imul(F, j)) + Math.imul(q, z)) | 0),
            (o = Math.imul(q, j)),
            (i = (i + Math.imul(U, K)) | 0),
            (n = ((n = (n + Math.imul(U, Q)) | 0) + Math.imul(T, K)) | 0),
            (o = (o + Math.imul(T, Q)) | 0),
            (i = (i + Math.imul(R, Y)) | 0),
            (n = ((n = (n + Math.imul(R, J)) | 0) + Math.imul(k, Y)) | 0),
            (o = (o + Math.imul(k, J)) | 0),
            (i = (i + Math.imul(C, W)) | 0),
            ...
            (n = ((n = (n + Math.imul(v, th)) | 0) + Math.imul(A, tu)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tS >>> 26)) | 0),
            (tS &= 0x3ffffff),
            (i = Math.imul(F, K)),
            (n = ((n = Math.imul(F, Q)) + Math.imul(q, K)) | 0),
            (o = Math.imul(q, Q)),
            (i = (i + Math.imul(U, Y)) | 0),
            (n = ((n = (n + Math.imul(U, J)) | 0) + Math.imul(T, Y)) | 0),
            (o = (o + Math.imul(T, J)) | 0),
            (i = (i + Math.imul(R, W)) | 0),
            ...
            (n = ((n = (n + Math.imul(v, td)) | 0) + Math.imul(A, tl)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tI >>> 26)) | 0),
            (tI &= 0x3ffffff),
            (i = Math.imul(F, Y)),
            (n = ((n = Math.imul(F, J)) + Math.imul(q, Y)) | 0),
            (o = Math.imul(q, J)),
            (i = (i + Math.imul(U, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tN >>> 26)) | 0),
            (tN &= 0x3ffffff),
            (i = Math.imul(F, W)),
            (n = ((n = Math.imul(F, X)) + Math.imul(q, W)) | 0),
            (o = Math.imul(q, X)),
            (i = (i + Math.imul(U, $)) | 0),
            ...
            (n = ((n = (n + Math.imul(M, td)) | 0) + Math.imul(E, tl)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tO >>> 26)) | 0),
            (tO &= 0x3ffffff),
            (i = Math.imul(F, tu)),
            (n = ((n = Math.imul(F, th)) + Math.imul(q, tu)) | 0),
            (o = Math.imul(q, th)),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tR >>> 26)) | 0),
            (tR &= 0x3ffffff),
            (i = Math.imul(F, tl)),
            (n = ((n = Math.imul(F, td)) + Math.imul(q, tl)) | 0),
            (o = Math.imul(q, td)),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tk >>> 26)) | 0),
            (tk &= 0x3ffffff),
            (i = Math.imul(F, tp)),
            (n = ((n = Math.imul(F, tm)) + Math.imul(q, tp)) | 0),
            (o = Math.imul(q, tm));
        ...
        Math.imul || (m = p),
          ...
          (n.prototype._wordDiv = function (t, e) {
            ...
            for (var l = u - 1; l >= 0; l--) {
              ...
              for (
                d = Math.min((d / f) | 0, 0x3ffffff), i._ishlnsubmul(o, d, l);
                0 !== i.negative;
        ...
        (A.prototype._tmp = function () {
          ...
          (M.prototype.sqrt = function (t) {
            ...
            for (
              ...
              (d = d.redMul(v)), (l = v.redSqr()), (c = c.redMul(l)), (p = g);
            }
            return d;
          }),
      ...
      class tR {
        ...
        fromTwos(t) {
          return tP(tU(this).fromTwos(t));
        }
        toTwos(t) {
          return tP(tU(this).toTwos(t));
        }
        abs() {
          return "-" === this._hex[0] ? tR.from(this._hex.substring(1)) : this;
        }
        add(t) {
          return tP(tU(this).add(tU(t)));
        }
        sub(t) {
          return tP(tU(this).sub(tU(t)));
        }
        div(t) {
          return (
            tR.from(t).isZero() && tT("division-by-zero", "div"),
            tP(tU(this).div(tU(t)))
          );
        }
        mul(t) {
          return tP(tU(this).mul(tU(t)));
        }
        mod(t) {
          let e = tU(t);
          return (
            e.isNeg() && tT("division-by-zero", "mod"), tP(tU(this).umod(e))
          );
        }
        pow(t) {
          let e = tU(t);
          return e.isNeg() && tT("negative-power", "pow"), tP(tU(this).pow(e));
        }
        and(t) {
          let e = tU(t);
          return (
            (this.isNegative() || e.isNeg()) &&
              tT("unbound-bitwise-result", "and"),
            tP(tU(this).and(e))
          );
        }
        or(t) {
        ...
        xor(t) {
          ...
          return (
            (this.isNegative() || e.isNeg()) &&
              tT("unbound-bitwise-result", "xor"),
            tP(tU(this).xor(e))
          );
        }
        mask(t) {
          return (
            (this.isNegative() || t < 0) && tT("negative-width", "mask"),
            tP(tU(this).maskn(t))
          );
        }
        shl(t) {
          return (
            (this.isNegative() || t < 0) && tT("negative-width", "shl"),
            tP(tU(this).shln(t))
          );
        }
        shr(t) {
          return (
            (this.isNegative() || t < 0) && tT("negative-width", "shr"),
            tP(tU(this).shrn(t))
          );
        }
        eq(t) {
          return tU(this).eq(tU(t));
        }
        lt(t) {
          return tU(this).lt(tU(t));
        }
        lte(t) {
          return tU(this).lte(tU(t));
        }
        gt(t) {
          return tU(this).gt(tU(t));
        }
        gte(t) {
          return tU(this).gte(tU(t));
        }
        isNegative() {
          return "-" === this._hex[0];
        }
        ...
        toNumber() {
          try {
            ...
            tT("overflow", "toNumber", this.toString());
          }
          return null;
        }
        toBigInt() {
        ...
        static from(t) {
          ...
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tR(t_, tk(t))
              : t.match(/^-?[0-9]+$/)
              ? new tR(t_, tk(new tB(t)))
              : tC.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
              t % 1 && tT("underflow", "BigNumber.from", t),
              (t >= 0x1fffffffffffff || t <= -0x1fffffffffffff) &&
                tT("overflow", "BigNumber.from", t),
              tR.from(String(t))
            );
          if ("bigint" == typeof t) return tR.from(t.toString());
          if (tm(t)) return tR.from(tb(t));
          if (t) {
            if (t.toHexString) {
              let e = t.toHexString();
              if ("string" == typeof e) return tR.from(e);
            } else {
              let e = t._hex;
              if (
                (null == e && "BigNumber" === t.type && (e = t.hex),
                "string" == typeof e &&
                  (tv(e) || ("-" === e[0] && tv(e.substring(1)))))
              )
                return tR.from(e);
            }
          }
          return tC.throwArgumentError("invalid BigNumber value", "value", t);
        }
      ...
      function tk(t) {
        ...
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tC.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tk(t)) ? t : "-" + t
          );
      ...
      function tU(t) {
        let e = tR.from(t).toHexString();
        return "-" === e[0]
          ? new tB("-" + e.substring(3), 16)
          : new tB(e.substring(2), 16);
      }
      function tT(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tC.throwError(t, ta.errors.NUMERIC_FAULT, i)
        );
      }
      let tD = new ta(tN),
        tF = {},
      ...
      function tz(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tD.throwError(t, ta.errors.NUMERIC_FAULT, n)
        );
      }
      let tj = "0";
      for (; tj.length < 256; ) tj += tj;
      function tH(t) {
        if ("number" != typeof t)
          try {
            t = tR.from(t).toNumber();
          } catch {}
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + tj.substring(0, t)
          : tD.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function tK(t, e) {
        null == e && (e = 0);
        let r = tH(e),
      ...
      function tQ(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tD.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tD.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tD.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          f = n[1];
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tD.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class tY {
        ...
        addUnsafe(t) {
          this._checkFormat(t);
          let e = tQ(this._value, this.format.decimals),
            r = tQ(t._value, t.format.decimals);
          return tY.fromValue(e.add(r), this.format.decimals, this.format);
        }
        subUnsafe(t) {
          this._checkFormat(t);
          let e = tQ(this._value, this.format.decimals),
            r = tQ(t._value, t.format.decimals);
          return tY.fromValue(e.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(t) {
          this._checkFormat(t);
          let e = tQ(this._value, this.format.decimals),
        ...
        floor() {
          ...
          1 === t.length && t.push("0");
          let e = tY.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(tJ.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = tY.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(tJ.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tD.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
          let r = tY.from("1" + tj.substring(0, t), this.format),
            i = tV.toFormat(this.format);
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tD.throwArgumentError("invalid byte width", "width", t),
              tw(
                tR
                  .from(this._hex)
        ...
        toFormat(t) {
          return tY.fromString(this._value, t);
        }
        static fromValue(t, e, r) {
          ...
          return (
            ...
            null == e && (e = 0),
            null == r && (r = "fixed"),
            tY.fromString(tK(t, e), tG.from(r))
          );
        }
        ...
        static fromBytes(t, e) {
          null == e && (e = "fixed");
          let r = tG.from(e);
          if (tg(t).length > r.width / 8) throw Error("overflow");
          let i = tR.from(t);
          return (
        ...
        static from(t, e) {
          if ("string" == typeof t) return tY.fromString(t, e);
          if (tm(t)) return tY.fromBytes(t, e);
          try {
            return tY.fromValue(t, 0, e);
          } catch (t) {
            if (t.code !== ta.errors.INVALID_ARGUMENT) throw t;
          }
          return tD.throwArgumentError("invalid FixedNumber value", "value", t);
        }
      ...
      function tZ(t, e = o.current) {
        e != o.current && (tW.checkNormalize(), (t = t.normalize(e)));
        let r = [];
        for (let e = 0; e < t.length; e++) {
        ...
        return (
          (t = (function (t) {
            ...
            for (;;) {
              ...
              if (0 == e) break;
              d.push(e);
              let f = c + Math.floor((p * o[e]) / n),
                s = c + Math.floor((p * o[e + 1]) / n) - 1;
              for (; !((f ^ s) & 0x40000000); )
                (l = ((l << 1) & 0x7fffffff) | a()),
                  (f = (f << 1) & 0x7fffffff),
                  (s = ((s << 1) & 0x7fffffff) | 1);
      ...
      t6(t5),
        ...
        (function (t) {
          ...
          for (;;) {
            let r = t() - 1;
            if (r < 0) break;
            e.push(t8(1 + t(), 1 + r, t).map((t) => [t[0], t.slice(1)]));
          }
          (function (t) {
            let e = {};
            for (let r = 0; r < t.length; r++) {
      ...
      let t4 = `Ethereum Signed Message:
`;
      function t9(t) {
        return (
          "string" == typeof t && (t = tZ(t)),
          tM(
            (function (t) {
              let e = t.map((t) => tg(t)),
                r = new Uint8Array(e.reduce((t, e) => t + e.length, 0));
              return e.reduce((t, e) => (r.set(e, t), t + e.length), 0), tc(r);
            })([tZ(t4), tZ(String(t.length)), t])
          )
        );
      }
      new ta("rlp/5.7.0");
      let t7 = new ta("address/5.7.0");
      function et(t) {
        tv(t, 20) || t7.throwArgumentError("invalid address", "address", t);
      ...
      let ee = {};
      for (let t = 0; t < 10; t++) ee[String(t)] = String(t);
      for (let t = 0; t < 26; t++)
        ee[String.fromCharCode(65 + t)] = String(10 + t);
      let er = Math.floor(
        Math.log10
      ...
      tR.from(
        ...
        tw(eo.toHexString(), 32),
        tw(en.toHexString(), 32);
      var ef = {},
        es = {};
      function eu(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      eu.equal = function (t, e, r) {
      ...
      (es.inherits = ea),
        ...
        (es.toHex = function (t) {
          for (var e = "", r = 0; r < t.length; r++) e += ed(t[r].toString(16));
          return e;
        }),
        (es.htonl = el),
        (es.toHex32 = function (t, e) {
          for (var r = "", i = 0; i < t.length; i++) {
            var n = t[i];
            "little" === e && (n = el(n)), (r += ec(n.toString(16)));
          }
          return r;
        }),
        (es.zero2 = ed),
        (es.zero8 = ec),
        (es.join32 = function (t, e, r, i) {
          var n,
            o = r - e;
          eu(o % 4 == 0);
        ...
        (es.rotr32 = function (t, e) {
          return (t >>> e) | (t << (32 - e));
        }),
        (es.rotl32 = function (t, e) {
          return (t << e) | (t >>> (32 - e));
        }),
        (es.sum32 = function (t, e) {
          return (t + e) >>> 0;
        }),
        (es.sum32_3 = function (t, e, r) {
          return (t + e + r) >>> 0;
        }),
        (es.sum32_4 = function (t, e, r, i) {
          return (t + e + r + i) >>> 0;
        }),
        (es.sum32_5 = function (t, e, r, i, n) {
          return (t + e + r + i + n) >>> 0;
        }),
        (es.sum64 = function (t, e, r, i) {
          var n = t[e],
            o = (i + t[e + 1]) >>> 0;
          (t[e] = ((o < i ? 1 : 0) + r + n) >>> 0), (t[e + 1] = o);
        }),
        (es.sum64_hi = function (t, e, r, i) {
          return (((e + i) >>> 0 < e ? 1 : 0) + t + r) >>> 0;
        }),
        (es.sum64_lo = function (t, e, r, i) {
          return (e + i) >>> 0;
        }),
        (es.sum64_4_hi = function (t, e, r, i, n, o, f, s) {
          var u,
            h = e;
          return (
            (t +
        ...
        (es.sum64_4_lo = function (t, e, r, i, n, o, f, s) {
          return (e + i + o + s) >>> 0;
        }),
        (es.sum64_5_hi = function (t, e, r, i, n, o, f, s, u, h) {
          var a,
            l = e;
          return (
            (t +
        ...
        (es.sum64_5_lo = function (t, e, r, i, n, o, f, s, u, h) {
          return (e + i + o + s + h) >>> 0;
        }),
        (es.rotr64_hi = function (t, e, r) {
          return ((e << (32 - r)) | (t >>> r)) >>> 0;
        }),
        (es.rotr64_lo = function (t, e, r) {
          return ((t << (32 - r)) | (e >>> r)) >>> 0;
        }),
        (es.shr64_hi = function (t, e, r) {
          return t >>> r;
        }),
        (es.shr64_lo = function (t, e, r) {
          return ((t << (32 - r)) | (e >>> r)) >>> 0;
        });
      var ep = {};
      function em() {
      ...
      (ep.BlockHash = em),
        (em.prototype.update = function (t, e) {
          if (
            ...
            (this.pending = t.slice(t.length - r, t.length)),
              ...
              (t = es.join32(t, 0, t.length - r, this.endian));
        ...
        (em.prototype.digest = function (t) {
          return (
            this.update(this._pad()), eu(null === this.pending), this._digest(t)
          );
        }),
        (em.prototype._pad = function () {
      ...
      (ev.ft_1 = function (t, e, r, i) {
        ...
        (ev.ch32 = function (t, e, r) {
          return (t & e) ^ (~t & r);
        }),
        (ev.maj32 = eb),
        (ev.p32 = function (t, e, r) {
          return t ^ e ^ r;
        }),
        (ev.s0_256 = function (t) {
          return eA(t, 2) ^ eA(t, 13) ^ eA(t, 22);
        }),
        (ev.s1_256 = function (t) {
          return eA(t, 6) ^ eA(t, 11) ^ eA(t, 25);
        }),
        (ev.g0_256 = function (t) {
          return eA(t, 7) ^ eA(t, 18) ^ (t >>> 3);
        }),
        (ev.g1_256 = function (t) {
          return eA(t, 17) ^ eA(t, 19) ^ (t >>> 10);
        });
      var ey = es.rotl32,
        ew = es.sum32,
        ex = es.sum32_5,
        eM = ev.ft_1,
        eE = ep.BlockHash,
        eS = [0x5a827999, 0x6ed9eba1, 0x8f1bbcdc, 0xca62c1d6];
      function eI() {
      ...
      es.inherits(eI, eE),
        ...
        (eI.hmacStrength = 80),
        (eI.padLength = 64),
        (eI.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = ey(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
          ...
          for (i = 0; i < r.length; i++) {
            var h = ~~(i / 20),
              a = ex(ey(n, 5), eM(h, o, f, s), u, r[i], eS[h]);
            (u = s), (s = f), (f = ey(o, 30)), (o = n), (n = a);
          }
          (this.h[0] = ew(this.h[0], n)),
            (this.h[1] = ew(this.h[1], o)),
            (this.h[2] = ew(this.h[2], f)),
            (this.h[3] = ew(this.h[3], s)),
            (this.h[4] = ew(this.h[4], u));
        }),
        (eI.prototype._digest = function (t) {
          return "hex" === t
            ? es.toHex32(this.h, "big")
      ...
      es.inherits(eF, eT),
        ...
        (eF.hmacStrength = 192),
        (eF.padLength = 64),
        (eF.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eB(eU(r[i - 2]), r[i - 7], eP(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
            ...
            a = this.h[6],
            l = this.h[7];
          for (eu(this.k.length === r.length), i = 0; i < r.length; i++) {
            var d = eC(l, ek(u), e_(u, h, a), this.k[i], r[i]),
              c = eN(eR(n), eO(n, o, f));
            (l = a),
              (a = h),
              (h = u),
          ...
          (this.h[0] = eN(this.h[0], n)),
            ...
            (this.h[5] = eN(this.h[5], h)),
            (this.h[6] = eN(this.h[6], a)),
            (this.h[7] = eN(this.h[7], l));
        }),
        ...
        (eq.prototype._digest = function (t) {
          return "hex" === t
            ? es.toHex32(this.h.slice(0, 7), "big")
            : es.split32(this.h.slice(0, 7), "big");
        });
      var eL = es.rotr64_hi,
        ez = es.rotr64_lo,
        ej = es.shr64_hi,
      ...
      es.inherits(e$, eX),
        ...
        (e$.hmacStrength = 192),
        (e$.padLength = 128),
        (e$.prototype._prepareBlock = function (t, e) {
          for (var r = this.W, i = 0; i < 32; i++) r[i] = t[e + i];
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
                var r = eL(t, e, 19) ^ eL(e, t, 29) ^ ej(t, e, 6);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 4], r[i - 3]),
              o = (function (t, e) {
                var r = ez(t, e, 19) ^ ez(e, t, 29) ^ eH(t, e, 6);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 4], r[i - 3]),
              f = r[i - 14],
              s = r[i - 13],
              u = (function (t, e) {
                var r = eL(t, e, 1) ^ eL(t, e, 8) ^ ej(t, e, 7);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 30], r[i - 29]),
              h = (function (t, e) {
                var r = ez(t, e, 1) ^ ez(t, e, 8) ^ eH(t, e, 7);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 30], r[i - 29]),
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = eY(n, o, f, s, u, h, a, l)),
              (r[i + 1] = eJ(n, o, f, s, u, h, a, l));
          }
        }),
        (e$.prototype._update = function (t, e) {
          ...
          for (var b = 0; b < r.length; b += 2) {
            var y = v,
              w = A,
              x = (function (t, e) {
                var r = eL(t, e, 14) ^ eL(t, e, 18) ^ eL(e, t, 9);
                return r < 0 && (r += 0x100000000), r;
              })(l, d),
              M = (function (t, e) {
              ...
              B = r[b],
              C = r[b + 1],
              _ = eV(y, w, x, M, E, S, I, N, B, C),
              O = eW(y, w, x, M, E, S, I, N, B, C);
            y = (function (t, e) {
              var r = eL(t, e, 28) ^ eL(e, t, 2) ^ eL(e, t, 7);
              return r < 0 && (r += 0x100000000), r;
            })(i, n);
            var R = eQ(
                y,
        ...
        (e0.prototype._digest = function (t) {
          return "hex" === t
            ? es.toHex32(this.h.slice(0, 12), "big")
            : es.split32(this.h.slice(0, 12), "big");
        }),
        (eg.sha1 = eI),
        (eg.sha224 = eq),
        (eg.sha256 = eF),
      ...
      es.inherits(e4, e5),
        ...
        (e4.hmacStrength = 192),
        (e4.padLength = 64),
        (e4.prototype._update = function (t, e) {
          for (
            var r = this.h[0],
              i = this.h[1],
              n = this.h[2],
          ...
          (m = e6(this.h[1], n, a)),
            (this.h[1] = e6(this.h[2], o, l)),
            (this.h[2] = e6(this.h[3], f, s)),
            (this.h[3] = e6(this.h[4], r, u)),
            (this.h[4] = e6(this.h[0], i, h)),
            (this.h[0] = m);
        }),
        (e4.prototype._digest = function (t) {
          return "hex" === t
            ? es.toHex32(this.h, "little")
            : es.split32(this.h, "little");
        });
      var e7 = [
      ...
      rf.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var rs = rn(function (t, e) {
          function r(t) {
            return 1 === t.length ? "0" + t : t;
          }
          function i(t) {
      ...
      function rd(t, e) {
        (this.type = t),
          (this.p = new tI(e.p, 16)),
          (this.red = e.prime ? tI.red(e.prime) : tI.mont(this.p)),
          (this.zero = new tI(0).toRed(this.red)),
          (this.one = new tI(1).toRed(this.red)),
          (this.two = new tI(2).toRed(this.red)),
          (this.n = e.n && new tI(e.n, 16)),
      ...
      (rd.prototype.point = function () {
        throw Error("Not implemented");
      }),
        (rd.prototype.validate = function () {
          throw Error("Not implemented");
        }),
        (rd.prototype._fixedNafMul = function (t, e) {
          rl(t.precomputed);
          var r = t._getDoubles(),
            i = rh(e, 1, this._bitLength),
        ...
        (rd.prototype._wnafMul = function (t, e) {
          var r = 4,
            i = t._getNAFPoints(r);
          r = i.wnd;
          for (
            var n = i.points,
              o = rh(e, r, this._bitLength),
        ...
        (rd.prototype._wnafMulAdd = function (t, e, r, i, n) {
          var o,
            f,
            s,
            u = this._wnafT1,
          ...
          for (o = 0; o < i; o++) {
            ...
            (u[o] = d.wnd), (h[o] = d.points);
          }
          for (o = i - 1; o >= 1; o -= 2) {
            var c = o - 1,
              p = o;
            if (1 !== u[c] || 1 !== u[p]) {
              (a[c] = rh(r[c], u[c], this._bitLength)),
                (a[p] = rh(r[p], u[p], this._bitLength)),
            ...
            for (
              ...
              var A = 0 | v[0][f],
                b = 0 | v[1][f];
              (a[c][f] = g[(A + 1) * 3 + (b + 1)]), (a[p][f] = 0), (h[c] = m);
            }
          }
        ...
        (rd.BasePoint = rc),
        (rc.prototype.eq = function () {
          throw Error("Not implemented");
        }),
        (rc.prototype.validate = function () {
          return this.curve.validate(this);
        }),
        (rd.prototype.decodePoint = function (t, e) {
          t = ru.toArray(t, e);
        ...
        (rc.prototype.encodeCompressed = function (t) {
          return this.encode(t, !0);
        }),
        (rc.prototype._encode = function (t) {
        ...
        (rc.prototype.encode = function (t, e) {
          return ru.encode(this._encode(e), t);
        }),
        (rc.prototype.precompute = function (t) {
        ...
        (rc.prototype._hasDoubles = function (t) {
        ...
        (rc.prototype._getDoubles = function (t, e) {
        ...
        (rc.prototype._getNAFPoints = function (t) {
        ...
        (rc.prototype._getBeta = function () {
          return null;
        }),
      ...
      var rp = rn(function (t) {
        ...
        rm = ru.assert;
      function rg(t) {
        rd.call(this, "short", t),
          (this.a = new tI(t.a, 16).toRed(this.red)),
          (this.b = new tI(t.b, 16).toRed(this.red)),
      ...
      function rv(t, e, r, i) {
        rd.BasePoint.call(this, t, "affine"),
          null === e && null === r
      ...
      function rA(t, e, r, i) {
        rd.BasePoint.call(this, t, "jacobian"),
      ...
      rp(rg, rd),
        (rg.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            ...
            if (t.lambda) r = new tI(t.lambda, 16);
              ...
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rm(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tI(t.a, 16), b: new tI(t.b, 16) };
                  })
        ...
        (rg.prototype._getEndoRoots = function (t) {
        ...
        (rg.prototype._getEndoBasis = function (t) {
          for (
            var e,
              r,
              i,
            ...
            var A = d.div(l);
            (u = d.sub(A.mul(l))), (h = m.sub(A.mul(c)));
            var b = g.sub(A.mul(p));
            if (!i && 0 > u.cmp(a))
              (e = s.neg()), (r = c), (i = u.neg()), (n = h);
            else if (i && 2 == ++v) break;
            (s = u), (d = l), (l = u), (m = c), (c = h), (g = p), (p = b);
          }
          (o = u.neg()), (f = h);
        ...
        (rg.prototype._endoSplit = function (t) {
        ...
        (rg.prototype.pointFromX = function (t, e) {
        ...
        (rg.prototype.validate = function (t) {
          if (t.inf) return !0;
          var e = t.x,
            r = t.y,
            i = this.a.redMul(e),
        ...
        (rg.prototype._endoWnafMulAdd = function (t, e, r) {
          for (
        ...
        rp(rv, rd.BasePoint),
        (rg.prototype.point = function (t, e, r) {
          return new rv(this, t, e, r);
        }),
        (rg.prototype.pointFromJSON = function (t, e) {
          return rv.fromJSON(this, t, e);
        }),
        (rv.prototype._getBeta = function () {
          if (this.curve.endo) {
        ...
        (rv.prototype.mulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
        ...
        (rv.prototype.jmulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
          return this.curve.endo
        ...
        (rv.prototype.toJ = function () {
          return this.inf
            ? this.curve.jpoint(null, null, null)
            : this.curve.jpoint(this.x, this.y, this.curve.one);
        }),
        rp(rA, rd.BasePoint),
        (rg.prototype.jpoint = function (t, e, r) {
          return new rA(this, t, e, r);
        }),
        (rA.prototype.toP = function () {
        ...
        (rA.prototype.add = function (t) {
          ...
          var h = s.redSqr(),
            a = h.redMul(s),
            l = i.redMul(h),
            d = u.redSqr().redIAdd(a).redISub(l).redISub(l),
            c = u.redMul(l.redISub(d)).redISub(o.redMul(a)),
            p = this.z.redMul(t.z).redMul(s);
          return this.curve.jpoint(d, c, p);
        }),
        (rA.prototype.mixedAdd = function (t) {
          ...
          var u = f.redSqr(),
            ...
            d = s.redMul(a.redISub(l)).redISub(n.redMul(h)),
            c = this.z.redMul(f);
        ...
        (rA.prototype.dblp = function (t) {
          ...
          for (e = 0; e < t; e++) {
            var a = o.redSqr(),
              l = h.redSqr(),
              d = l.redSqr(),
              c = a.redAdd(a).redIAdd(a).redIAdd(i.redMul(u)),
              p = o.redMul(l),
            ...
            var A = h.redMul(s);
            e + 1 < t && (u = u.redMul(d)), (o = m), (s = A), (h = v);
          }
        ...
        (rA.prototype._zeroDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (rA.prototype._threeDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (rA.prototype.trpl = function () {
          ...
          var d = this.y.redMul(h.redMul(u.redISub(h)).redISub(f.redMul(s)));
          d = (d = (d = d.redIAdd(d)).redIAdd(d)).redIAdd(d);
          var c = this.z.redAdd(f).redSqr().redISub(r).redISub(s);
          return this.curve.jpoint(l, d, c);
        }),
        (rA.prototype.mul = function (t, e) {
          return (t = new tI(t, e)), this.curve._wnafMul(this, t);
        }),
        (rA.prototype.eq = function (t) {
        ...
        (rA.prototype.eqXToP = function (t) {
          var e = this.z.redSqr(),
      ...
      var rb = rn(function (t, e) {
          (e.base = rd), (e.short = rg), (e.mont = null), (e.edwards = null);
        }),
        ry = rn(function (t, e) {
          var r,
            i = ru.assert;
          function n(t) {
            "short" === t.type
              ? (this.curve = new rb.short(t))
              : "edwards" === t.type
              ? (this.curve = new rb.edwards(t))
              : (this.curve = new rb.mont(t)),
              (this.g = this.curve.g),
              (this.n = this.curve.n),
              (this.hash = t.hash),
      ...
      function rw(t) {
        ...
        (this.hash = t.hash),
          ...
          (this.K = null),
          (this.V = null);
        var e = rs.toArray(t.entropy, t.entropyEnc || "hex"),
          r = rs.toArray(t.nonce, t.nonceEnc || "hex"),
          i = rs.toArray(t.pers, t.persEnc || "hex");
        ro(
      ...
      (rw.prototype._init = function (t, e, r) {
        ...
        (rw.prototype._hmac = function () {
          return new ef.hmac(this.hash, this.K);
        }),
        (rw.prototype._update = function (t) {
        ...
        (rw.prototype.reseed = function (t, e, r, i) {
        ...
        (rw.prototype.generate = function (t, e, r, i) {
          if (this._reseed > this.reseedInterval)
            throw Error("Reseed is required");
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = rs.toArray(r, i || "hex")), this._update(r));
          for (var n = []; n.length < t; )
            (this.V = this._hmac().update(this.V).digest()),
              (n = n.concat(this.V));
          var o = n.slice(0, t);
          return this._update(r), this._reseed++, rs.encode(o, e);
        });
      var rx = ru.assert;
      function rM(t, e) {
        (this.ec = t),
      ...
      (rM.fromPublic = function (t, e, r) {
        return e instanceof rM ? e : new rM(t, { pub: e, pubEnc: r });
      }),
        (rM.fromPrivate = function (t, e, r) {
          return e instanceof rM ? e : new rM(t, { priv: e, privEnc: r });
        }),
        (rM.prototype.validate = function () {
        ...
        (rM.prototype.getPublic = function (t, e) {
          return (
        ...
        (rM.prototype.getPrivate = function (t) {
          return "hex" === t ? this.priv.toString(16, 2) : this.priv;
        }),
        (rM.prototype._importPrivate = function (t, e) {
          (this.priv = new tI(t, e || 16)),
            (this.priv = this.priv.umod(this.ec.curve.n));
        }),
        (rM.prototype._importPublic = function (t, e) {
          if (t.x || t.y) {
            "mont" === this.ec.curve.type
              ? rx(t.x, "Need x coordinate")
              : ("short" === this.ec.curve.type ||
                  "edwards" === this.ec.curve.type) &&
                rx(t.x && t.y, "Need both x and y coordinate"),
              (this.pub = this.ec.curve.point(t.x, t.y));
            return;
          }
          this.pub = this.ec.curve.decodePoint(t, e);
        }),
        (rM.prototype.derive = function (t) {
          return (
            t.validate() || rx(t.validate(), "public point not validated"),
            t.mul(this.priv).getX()
          );
        }),
        (rM.prototype.sign = function (t, e, r) {
          return this.ec.sign(t, this, e, r);
        }),
        (rM.prototype.verify = function (t, e) {
      ...
      function rS(t, e) {
        ...
        this._importDER(t, e) ||
          (rE(t.r && t.s, "Signature without r or s"),
          (this.r = new tI(t.r, 16)),
          (this.s = new tI(t.s, 16)),
      ...
      (rS.prototype._importDER = function (t, e) {
        t = ru.toArray(t, e);
        var r = new rI();
        ...
        (rS.prototype.toDER = function (t) {
          ...
          for (
            ...
            r = r.slice(1);
          var i = [2];
          rC(i, e.length), (i = i.concat(e)).push(2), rC(i, r.length);
          var n = i.concat(r),
            o = [48];
          return rC(o, n.length), (o = o.concat(n)), ru.encode(o, t);
        });
      var r_ = function () {
      ...
      function rR(t) {
        ...
        "string" == typeof t &&
          (rO(
            Object.prototype.hasOwnProperty.call(ry, t),
            "Unknown curve " + t
          ),
          (t = ry[t])),
          t instanceof ry.PresetCurve && (t = { curve: t }),
      ...
      (rR.prototype.keyPair = function (t) {
        return new rM(this, t);
      }),
        (rR.prototype.keyFromPrivate = function (t, e) {
          return rM.fromPrivate(this, t, e);
        }),
        (rR.prototype.keyFromPublic = function (t, e) {
          return rM.fromPublic(this, t, e);
        }),
        (rR.prototype.genKeyPair = function (t) {
          t || (t = {});
          for (
            var e = new rw({
                hash: this.hash,
                ...
                entropy: t.entropy || r_(this.hash.hmacStrength),
                entropyEnc: (t.entropy && t.entropyEnc) || "utf8",
                nonce: this.n.toArray(),
              }),
              r = this.n.byteLength(),
              i = this.n.sub(new tI(2));
            ;
        ...
        (rR.prototype._truncateToN = function (t, e) {
        ...
        (rR.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            i || (i = {}),
            (e = this.keyFromPrivate(e, r)),
            (t = this._truncateToN(new tI(t, 16)));
          for (
            var n = this.n.byteLength(),
              ...
              u = this.n.sub(new tI(1)),
              h = 0;
            ;
            h++
          ) {
            var a = i.k ? i.k(h) : new tI(s.generate(this.n.byteLength()));
            if (
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rS({ r: c, s: p, recoveryParam: m })
                    );
                  }
                }
              }
        ...
        (rR.prototype.verify = function (t, e, r, i) {
          (t = this._truncateToN(new tI(t, 16))),
            (r = this.keyFromPublic(r, i));
          var n = (e = new rS(e, "hex")).r,
            o = e.s;
          if (
            0 > n.cmpn(1) ||
            n.cmp(this.n) >= 0 ||
        ...
        (rR.prototype.recoverPubKey = function (t, e, r, i) {
          rO((3 & r) === r, "The recovery param is more than two bits"),
            (e = new rS(e, i));
          var n = this.n,
            o = new tI(t),
            f = e.r,
          ...
          var a = e.r.invm(n),
            ...
            d = s.mul(a).umod(n);
          return this.g.mulAdd(l, f, d);
        }),
        (rR.prototype.getKeyRecoveryParam = function (t, e, r, i) {
          if (null !== (e = new rS(e, i)).recoveryParam) return e.recoveryParam;
          for (var n, o = 0; o < 4; o++) {
            try {
      ...
      let rP = new ta("signing-key/5.7.0"),
        rU = null;
      function rT() {
        return rU || (rU = new rk("secp256k1")), rU;
      }
      class rD {
        constructor(t) {
          ei(this, "curve", "secp256k1"),
            ei(this, "privateKey", tb(t)),
            32 !==
              (function (t) {
                if ("string" != typeof t) t = tb(t);
                else if (!tv(t) || t.length % 2) return null;
                return (t.length - 2) / 2;
              })(this.privateKey) &&
              rP.throwArgumentError(
                "invalid private key",
                "privateKey",
                "[[ REDACTED ]]"
              );
          let e = rT().keyFromPrivate(tg(this.privateKey));
          ei(this, "publicKey", "0x" + e.getPublic(!1, "hex")),
            ei(this, "compressedPublicKey", "0x" + e.getPublic(!0, "hex")),
            ei(this, "_isSigningKey", !0);
        }
        _addPoint(t) {
          let e = rT().keyFromPublic(tg(this.publicKey)),
            r = rT().keyFromPublic(tg(t));
        ...
        signDigest(t) {
          let e = rT().keyFromPrivate(tg(this.privateKey)),
            r = tg(t);
          32 !== r.length &&
            rP.throwArgumentError("bad digest length", "digest", t);
          let i = e.sign(r, { canonical: !0 });
          return tx({
            recoveryParam: i.recoveryParam,
            r: tw("0x" + i.r.toString(16), 32),
            s: tw("0x" + i.s.toString(16), 32),
          });
        }
        computeSharedSecret(t) {
          let e = rT().keyFromPrivate(tg(this.privateKey)),
            r = rT().keyFromPublic(tg(rF(t)));
          return tw("0x" + e.derive(r.getPublic()).toString(16), 32);
        }
      ...
      function rF(t, e) {
        ...
        if (32 === r.length) {
          let t = new rD(r);
          return e
            ? "0x" + rT().keyFromPrivate(r).getPublic(!0, "hex")
            : t.publicKey;
        }
        return 33 === r.length
          ? e
            ? tb(r)
            : "0x" + rT().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? e
            ? "0x" + rT().keyFromPublic(r).getPublic(!0, "hex")
            : tb(r)
          : rP.throwArgumentError(
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    t7.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      t7.throwArgumentError("bad icap checksum", "address", t),
                      e = new tB(t.substring(4), 36).toString(16);
                    e.length < 40;

                  )
                    e = "0" + e;
                  e = et("0x" + e);
                } else t7.throwArgumentError("invalid address", "address", t);
                return e;
              })(
                ty(
                  tM(
                      ...
                      rF(
                        (function (t, e) {
                          ...
                          return (
                            "0x" +
                            rT()
                              .recoverPubKey(tg(t), i, r.recoveryParam)
                              .encode("hex", !1)
                          );
                        })(tg(t9(e)), f)
                      ),
      ...
      var rz = Object.defineProperty,
        ...
        rY = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        rJ = (t, e) => {
          for (var r in e || (e = {})) rQ.call(e, r) && rY(t, r, e[r]);
          if (rK) for (var r of rK(e)) rG.call(e, r) && rY(t, r, e[r]);
          return t;
        },
        rV = (t, e) => rj(t, rH(e));
      let rW = (t) => t?.split(":"),
      ...
      async function r0(t) {
        let { cacao: e, projectId: r } = t,
          ...
          o = r1(n, n.iss),
          f = r$(n.iss);
        return await rq(f, o, i, rX(n.iss), r);
      }
      let r1 = (t, e) => {
...
- ${t}`
        ...
        return (
          ...
          [r, i, "", n, "", o, f, s, u, h, a].filter((t) => null != t).join(`
`)
        );
      };
      function r2(t) {
      ...
      function r6(t) {
        ...
        let r =
          ...
          JSON.parse(w.from(e, "base64").toString("utf-8")));
        return r2(r), r;
      }
      function r8(t, e, r) {
        return r3(
      ...
      function is() {
        let t = v.TZ();
        return {
          privateKey: (0, A.dI)(t.secretKey, ie),
          publicKey: (0, A.dI)(t.publicKey, ie),
        };
      }
      function iu() {
      ...
      function ih(t, e) {
        let r = v.Tc((0, A.sH)(t, ie), (0, A.sH)(e, ie), !0),
          i = new p.i(g.aD, r).expand(32);
        return (0, A.dI)(i, ie);
      }
      function ia(t) {
        let e = (0, g.tW)((0, A.sH)(t, ie));
        return (0, A.dI)(e, ie);
      }
      function il(t) {
        let e = (0, g.tW)((0, A.sH)(t, ii));
        return (0, A.dI)(e, ie);
      }
      function id(t) {
        return Number((0, A.dI)(t, it));
      }
      function ic(t) {
        var e;
        let r = ((e = "u" > typeof t.type ? t.type : 0), (0, A.sH)(`${e}`, it));
        if (id(r) === io && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let i =
            "u" > typeof t.senderPublicKey
              ? (0, A.sH)(t.senderPublicKey, ie)
              : void 0,
          n = "u" > typeof t.iv ? (0, A.sH)(t.iv, ie) : (0, m.randomBytes)(12);
        return (function (t) {
          if (id(t.type) === io) {
            if (typeof t.senderPublicKey > "u")
              throw Error("Missing sender public key for type 1 envelope");
            return (0, A.dI)(
              (0, A.xW)([t.type, t.senderPublicKey, t.iv, t.sealed]),
              ir
            );
          }
          return (0, A.dI)((0, A.xW)([t.type, t.iv, t.sealed]), ir);
        })({
          type: r,
          sealed: new c.g6((0, A.sH)(t.symKey, ie)).seal(
            n,
            (0, A.sH)(t.message, ii)
          ),
          iv: n,
      ...
      function ip(t) {
        let e = new c.g6((0, A.sH)(t.symKey, ie)),
          { sealed: r, iv: i } = im(t.encoded),
          n = e.open(i, r);
      ...
      function im(t) {
        ...
        if (id(r) === io) {
          let t = e.slice(1, 33),
            i = e.slice(33, 45);
          return { type: r, sealed: e.slice(45), iv: i, senderPublicKey: t };
        }
        let i = e.slice(1, 13);
        return { type: r, sealed: e.slice(13), iv: i };
      }
      function ig(t, e) {
        let r = im(t);
        return iv({
      ...
      var iw = Object.defineProperty,
        ...
        iN = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        iB = (t, e) => {
          for (var r in e || (e = {})) iS.call(e, r) && iN(t, r, e[r]);
          if (iE) for (var r of iE(e)) iI.call(e, r) && iN(t, r, e[r]);
          return t;
        },
        iC = (t, e) => ix(t, iM(e));
      function i_(t) {
      ...
      function ij(t, e) {
        ...
        for (let [e, i] of Object.entries(r))
          i.methods ? (i.methods = X(i.methods, t)) : (i.methods = t),
      ...
      function iQ(t, e) {
        let { message: r, code: i } = iK[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function iG(t, e) {
        let { message: r, code: i } = iH[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function iY(t, e) {
        return (
      ...
      function iW(t, e) {
        return !!(e && iV(t)) || ("string" == typeof t && !!t.trim().length);
      }
      function iX(t, e) {
        return !!(e && iV(t)) || ("number" == typeof t && !isNaN(t));
      }
      function iZ(t, e) {
        ...
        return (
          ...
          (i.forEach((e) => {
            let { accounts: i, methods: n, events: f } = t.namespaces[e],
              s = iq(i),
              u = r[e];
            (q(E(e, u), s) && q(u.methods, n) && q(u.events, f)) || (o = !1);
          }),
          o)
        );
      }
      function i$(t) {
        return !!(iW(t, !1) && t.includes(":")) && 2 === t.split(":").length;
      }
      function i0(t) {
        if (iW(t, !1))
          try {
      ...
      function i6(t) {
        let e = !0;
        return (
          iY(t) ? t.length && (e = t.every((t) => iW(t, !1))) : (e = !1), e
        );
      }
      function i8(t, e) {
        let r = null;
      ...
      function ni(t) {
        return !(iV(t) || !iW(t.method, !1));
      }
      function nn(t) {
        return !(
          iV(t) ||
          (iV(t.result) && iV(t.error)) ||
          !iX(t.id, !1) ||
          !iW(t.jsonrpc, !1)
        );
      }
      function no(t) {
        return !(iV(t) || !iW(t.name, !1));
      }
      function nf(t, e) {
        return !(
          !i$(e) ||
      ...
      function ns(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                iq(t.accounts).includes(e) && r.push(...t.methods);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      function nu(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                iq(t.accounts).includes(e) && r.push(...t.events);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      Approved: ${s.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          f.forEach((t) => {
            i ||
              (q(n[t].methods, o[t].methods)
                ? q(n[t].events, o[t].events) ||
                  (i = iQ(
                    "NON_CONFORMING_NAMESPACES",
